...
function initMap() {
  ...
  pipeMap.addLayer(OSMLayer);
	...
	// 			var pipelineLayer = commonMap.IVecLayer.initVecLayerFromREST(config.URL.pipelineLayer, config.map.layerName.pipeline, regionStyle, pipeMap);
	// 			Global.layer.pipelineLayer = pipelineLayer;
	// 			console.log("在ON的状态下");
	// 		} else {
	// 			var pipelineLayer = commonMap.IVecLayer.initVecLayerFromREST(config.URL.pipelineLayer, config.map.layerName.pipeline, gridStyle, pipeMap);
	// 			Global.layer.pipelineLayer = pipelineLayer;
